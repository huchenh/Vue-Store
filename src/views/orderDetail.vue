		  ...
		  <div class="container">
		    <div class="checkout-order">
		      ...
		      <div class="check-step">
		        <ul>
		          <li class="cur"><span>View your</span> order Detail</li>
		        </ul>
		      </div>
		            ...
		            <li v-for="(item,index) in cartList" :key="index">
		              <div class="cart-tab-1">
		                <div class="cart-item-pic">
		                  <img :src="'/static/'+item.product_image" :alt="item.product_name">
		                </div>
		              ...
		              <div class="cart-tab-2">
		                <div class="item-price">{{item.sale_price | currency('$')}}</div>
		              </div>
		              <div class="cart-tab-3">
		                <div class="item-quantity">
		                  <div class="select-self">
		                    <div class="select-self-area">
		                      <span class="select-ipt">×{{item.orderGoods.product_count}}</span>
		                    </div>
		                  </div>
		              ...
		              <div class="cart-tab-4">
		                <div class="item-price-total">{{(item.sale_price*item.orderGoods.product_count) | currency('$')}}</div>
		              </div>
		            </li>
		          </ul>
		        </div>
		      ...
		      <div class="price-count-wrap">
                ...
                <li>
		              ...
		              <span>{{addressInfo.street_name }}</span>
		            </li>
                <li>
		              <span>Post Code:</span>
		              <span>{{addressInfo.post_code}}</span>
		            </li>
                <li>
          ...
          params:{
            orderId:this.$route.query.orderId
					...
					this.cartList.forEach((item)=>{
							this.subTotal += item.orderGoods.product_count*item.sale_price;
					})
