<template>
	<div>
		      ...
		      <div class="addr-list-wrap">
		        <div class="addr-list">
		          <ul>
		            ...
		            <li class="addr-new" @click="addressModalFlag=true">
		        ...
		        <div class="shipping-addr-more">
		          <a class="addr-more-btn up-down-btn" href="javascript:;" @click='exspand' :class="{'open':limit > 3 }">
		            more
		            <i class="i-up-down">
		...
		<div class="md-modal modal-msg md-modal-transition" :class="{'md-show':addressModalFlag}">
            ...
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="errorTip" v-text="errMessage"></span>
                </div>
                <ul>
                  ...
                  <li class="regi_form_input noMargin">
                    ...
                    <input type="text" tabindex="2"   v-model="streetName"  class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="streetName" >
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="number" tabindex="3"   v-model="postCode"  class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="postCode" >
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="tel" tabindex="4"   v-model="tel"  class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="tel" >
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" class="btn-login" @click="addAddress">提  交</a>
              </div>
            </div>
          </div>
        </div>
        <div class="md-overlay" v-show="addressModalFlag" @click="addressModalFlag=false"></div>
...
<script>
	...
	export default {
		...
		methods:{
			addAddress(){
				let userName = this.userName,streetName = this.streetName,postCode=this.postCode,tel=this.tel;
				if(userName == '' || streetName=='' || postCode == '' || tel==''){
					this.errMessage='地址信息不能为空';
					this.errorTip = true;
					return;
				}
				axios.post('/users/addAddress',{userName:this.userName,streetName:this.streetName,postCode:this.postCode,tel:this.tel}).then((response)=>{
