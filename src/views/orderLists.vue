        ...
        <div class="checkout-addr">
          ...
          <div class="check-step">
            <ul>
              ...
              <li class="cur">
                <span>View your</span> orderLists
              </li>
          ...
          <div class="addr-list-wrap">
            <div class="addr-list price-count">
              <ul>
                <li v-for="(item,index) in orderListFilter"
                  :key="index" @click="getDetail(item.order_id)">
                  <div>
                    <span>Item subtotal:</span>
                    <span>{{item.order_id }}</span>
                  </div>
                  <div>
                    <span>Prouct counts:</span>
                    <span>{{item.goods.length }}</span>
                  </div>
                   <div>
                    <span>StreetName:</span>
                    <span>{{item.address.street_name}} 湖南科技大学</span>
                  </div>
                  <div>
                    <span>Discount:</span>
                  ...
                  <div class="order-total-price">
                    ...
                    <span>{{item.order_total | currency('$')}}</span>
                  </div>

                  <div class="addr-opration addr-del">
                    <a href="javascript:;" class="addr-del-btn">More</a>
                  </div>
                </li>
